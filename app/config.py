...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        claude_model_easy=_get("CLAUDE_MODEL_EASY", "haiku"),
        claude_model_medium=_get("CLAUDE_MODEL_MEDIUM", "sonnet"),
        claude_model_hard=_get("CLAUDE_MODEL_HARD", "opus"),
        claude_model_judge=_get("CLAUDE_MODEL_JUDGE", "haiku"),
